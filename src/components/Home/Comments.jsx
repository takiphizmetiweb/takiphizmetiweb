    ...
    return(
        <>
            <div className="flex flex-col items-center h-[500px] my-62">
                    ...
                    <SwiperSlide>
                        <div className='bg-theme-gray p-6 ps-10 flex flex-col  rounded-lg w-[800px]'>
                            <div className="flex lg.flex-row flex-col gap-3">
                                <p className='inter-600 text-bold text-white text-2xl lg:text-5xl'>Tunahan Çiftçi <span className='inter-500 text-regular lg:block hidden text-5xl'>/</span></p>
                ...
                <button className='bg-red-500 hover:bg-red-600 transition-all duration-300 w-[200px] lg:w-[250px] text-center rounded-lg py-4 text-xl lg:text-3xl roboto-600 text-bold text-white'>Daha Fazla</button>
            </div>
        </>
    )
}
